...
# Link Hosting Kalian
lakmalvpn="raw.githubusercontent.com/sandaru-star/SLv2ray/main/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${lakmalvpn}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${lakmalvpn}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${lakmalvpn}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${lakmalvpn}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${lakmalvpn}/renewssr.sh && chmod +x /usr/bin/renewssr
