#!/bin/bash
#shadowsocks-libev obfs install by Lakmal
...
# Link Hosting 
lakmalvpn="raw.githubusercontent.com/sandaru-star/SLv2ray/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${lakmalvpn}/addss.sh"
wget -O delss "https://${lakmalvpn}/delss.sh"
wget -O cekss "https://${lakmalvpn}/cekss.sh"
wget -O renewss "https://${lakmalvpn}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
