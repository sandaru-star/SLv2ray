...
# ==================================================
# Link Hosting Kalian
lakmalvpn="raw.githubusercontent.com/sandaru-star/SLv2ray/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${lakmalvpn}/addwg.sh"
wget -O delwg "https://${lakmalvpn}/delwg.sh"
wget -O renewwg "https://${lakmalvpn}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
