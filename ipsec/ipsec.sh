...
# ==================================================
# Link Hosting Kalian
lakmalvpn="raw.githubusercontent.com/sandaru-star/SLv2ray/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${lakmalvpn}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${lakmalvpn}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${lakmalvpn}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${lakmalvpn}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${lakmalvpn}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${lakmalvpn}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
