...
# Link Hosting 
lakmalvpn="raw.githubusercontent.com/sandaru-star/SLv2ray/main/sstp"
...
wget -O /etc/accel-ppp.conf "https://${lakmalvpn}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${lakmalvpn}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${lakmalvpn}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${lakmalvpn}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${lakmalvpn}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
